...
public class StructureOption {
    public static StructureOption[] allowed_structures = {new StructureOption(StructureFeature.BURIED_TREASURE), new StructureOption(StructureFeature.DESERT_PYRAMID)};
